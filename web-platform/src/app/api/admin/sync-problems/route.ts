    ...
    for (const stage of courseStages) {
      ...
      for (const mod of stage.modules) {
        ...
        for (const exercise of mod.exercises) {
          ...
          // 确定题目类型
          let problemType: "reading" | "quiz" | "text_exact" | "compile_run" | "code_with_grader" | "link_object" | "makefile_project" | "testgen" | "project" = "compile_run";
          let displayType: "standard" | "reading" | "quiz" | "multi_file" | "testgen" = "standard";
